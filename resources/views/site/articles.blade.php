...
@section('content')
    <section>
        <div class="container col-md-7" style="margin-top: 40px;">
            ...
            @else
                <div class="">
                    <a href="{{ route('site.article.full.show', $feature_article[0]->slug) }}">
                        <h2 class="put-red">{{ $feature_article[0]->title }}</h2>
                        <p class="text-dark">
                        ...
                        <img src="/article_covers/{{ $feature_article[0]->image }}" class="img-fluid col-md-12" style="max-height: 450px;">
                ...
                @foreach($articles as $article)
                    <div class="row justify-content-start">
                        ...
                        <div class="col-sm-8 col-md-8 col-lg-8">
                            <a class="text-warning" href="{{ route('site.article.full.show', $article->slug) }}">
                            ...
                            <div class="card h-100" style="border:none;">
                                <a href="{{ route('site.article.full.show', $more->slug) }}">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @endforeach
                                        <h4 class="card-title">
                                            <a class="text-warning" href="{{ route('site.article.full.show', $more->slug) }}">{{ $more->title }}</a>
                                        </h4>
