...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><b>Edit Magazine</b></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="col-12">
        <div class="card card-outline card-dark">
            ...
            <form role="form" method="post" action="{{ route('magazine.update', $magazine->id) }}" id="form_submit" enctype="multipart/form-data">
                @csrf
                <div class="card-body m-1">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label for="title" class="form-label">Magazine Title</label>
                            <input type="text" name="title" value="{{ $magazine->title }}" class="form-control" placeholder="enter magazine title" id="title">
                            @if ($errors->has('title'))
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="issue" value="{{ $magazine->issue }}" class="form-control" placeholder="enter magazine issue e.g June-September 2021">
                            @if ($errors->has('issue'))
                ...
                <div class="card-footer">
                    <input type="submit" id="submit_button" value="Update Magazine" name="save_magazines" class="btn background-gold">
                </div>
