<nav class="navbar navbar-expand-lg navbar-gray bg-gray">
    <div class="container-fluid">
        <a href="{{ route('site.home') }}" class="navbar-brand ">
            <img src="{{ asset('site_images/firstcodeLogo.png') }}" alt="" class="img-fluid" style="height: 50px; width: 150px;">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item text-uppercase">
                    <a class="nav-link active text-uppercase" aria-current="page" href="{{ route('site.articles.show') }}">Articles</a>
                </li>
                ...
                {{--                                                                            <a style="text-decoration: none; width: auto;  display: inline-block;" class="text-warning card-link" href="{{ route('site.article.full.show', $one_category[$a]->slug) }}">--}}
...
{{--                                    <a  href="{{ route('site.category.all.articles.show', $category->slug) }}">{{ \Illuminate\Support\Str::upper($category->title) }}</a>--}}
{{--                                </div>--}}
{{--                            @endforeach--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
                ...
                <li class="nav-item dropdown text-uppercase">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        @foreach($all_categories as $category)
                            <li>
                                <a class="dropdown-item"  href="{{ route('site.category.all.articles.show', $category->slug) }}">{{ \Illuminate\Support\Str::upper($category->title) }}</a>
                            </li>
                        @endforeach
                    </ul>
                </li>
                ...
                <li class="nav-item text-uppercase">
                    <a class="nav-link scrollto text-uppercase" aria-current="page" href="#about">About us</a>
                </li>

                <li class="nav-item text-uppercase">
                    <a class="nav-link scrollto text-uppercase" aria-current="page" href="#faq">FAQ</a>
                </li>

                <li class="nav-item text-uppercase">
                    <a class="nav-link active text-uppercase" aria-current="page" href="#footer">Contacts</a>
                </li>
